     ...
     <div class="store-container">
        <div class="border-animation">
            <svg role="img" xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
              <title >Store animation loader</title>
                <defs>
                    <filter id="f1">
                    ...
                    <g id="ball">
                      ...
                      <g id="plane">
                        ...
                        <use class="helix" href="#helix" filter="url(#f1)"></use>
                    ...
                    <use class="box" href="#box" x="20" y="30"></use>
                    <use class="parachute" href="#parachute" x="20" y="-112"></use>
                    <rect fill="white" x="320" y="310" width="665" height="238"></rect>
                    <use class="tshirt" href="#tshirt"></use>
                    <use class="cap" href="#cap" y="-150"></use>
                    <use class="ball" href="#ball" y="-140"></use>
                    <use class="sky-circle" href="#sky-circle" x="-10px" y="5"></use>
                    <use class="sky-circle2" href="#sky-circle" x="500px" y="-125"></use>
                    <use class="sky-circle3" href="#sky-circle" x="1000px" y="50"></use>
                    <use class="cloud" href="#cloud2" x="0" y="10"></use>
                    <use class="plane" href="#plane" y="-80"></use>
                                
                    <use class="cloud2" href="#cloud" x="0" y="130"></use>
                    <use class="trees" href="#tree" x="40" y="0"></use>
                    <circle class="cat-shadow" fill="#0170BB" cx="1160" cy="620" r="23"></circle>
                    <use class="cat" href="#cat" x="15" y="5"></use>
                  <g id="browser">
                  ...
                  <g id="toldo">
                      ...
                      <use class="tol" href="#tol" x="-250"></use>
                      <use class="tol" href="#tol" x="334"></use>
                      <use class="tol" href="#tol" x="417"></use>
                  ...
                  <g id="door">
                    ...
                    <use class="grass" href="#grass" x="130" y="0"></use>
